    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">AI Use Case Examples</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Browse real-world AI implementations across professional sectors with their ethical assessment scores. 
            These examples demonstrate the range of ethical considerations across different AI use cases.
          </p>
        </div>
